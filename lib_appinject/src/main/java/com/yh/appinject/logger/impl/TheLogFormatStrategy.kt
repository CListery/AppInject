...
class TheLogFormatStrategy private constructor(builder: Builder) : FormatStrategy {
    ...
    class Builder {
        ...
        private val stackFilterClassNames = hashSetOf(
            Class.forName("com.yh.appinject.logger.Logs").name,
            Class.forName("com.yh.appinject.logger.LibLogs").name,
            Class.forName("com.yh.appinject.logger.ext.ExtInjectHelper").name,
